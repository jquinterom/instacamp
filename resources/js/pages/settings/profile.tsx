                ...
                <div className="space-y-6">
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div className="grid gap-2">
                            ...
                            <img src={`/storage/${auth.user.profile_image}`} alt="Profile image" className="h-24 w-24 rounded-full object-cover" />

                            <Input id="profile_image" type="file" className="mt-1 block w-full" accept="image/*" onChange={handleImageChange} />
